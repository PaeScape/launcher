...
application {
    project.setProperty("mainClassName", "online.paescape.launcher.Launcher")
}
...
tasks {
    ...
    processResources {
        ...
        doLast {
            ...
            copy {
                ...
                into("${buildDir}/resources/main/online/paescape/launcher")
    ...
    jar {
        manifest {
            attributes(mutableMapOf("Main-Class" to "online.paescape.launcher.Launcher"))
        }
    }

    shadowJar {
        archiveBaseName.set("PaeScapeLauncher")
